...
?>
<div class="container-fluid o-field mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2">
                                <div class="prod-item text-center " data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <img src="../assets/uploads/element-banner2-right.jpg" class="rounded" width="75%">
                                        <h4> 
                                            <?php echo $row['name'] ?>
                                        </h4>
                                        <h6>
            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 bg-white mb-1">
                                <label for="" class="text-dark mt-2"><b>Customer Name </b></label>
                                <input type="text" class="form-control-sm ml-2" name="order_number" value="<?php echo isset($order_number) ? $order_number : '' ?>" required>
